...
describe('createControlsDOM', () => {
  it('returns all required elements', () => {
    ...
    expect(dom.autoplayBtn).toBeDefined()
  ...
  it('uses shared control primitives for row controls', () => {
    ...
    expect(dom.autoplayBtn.classList.contains('irc-control-button')).toBe(true)
    expect(dom.autoplayBtn.classList.contains('irc-compact-control')).toBe(true)
    expect(dom.autoplayBtn.classList.contains('irc-icon-control')).toBe(true)
  ...
  it('can create PiP controls in another document', () => {
    ...
    expect(dom.autoplayBtn.ownerDocument).toBe(pipDocument)
